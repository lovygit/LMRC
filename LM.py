...
from utils import saveModel, loadModel, load_cifar10_online, load_cifar100_online, load_ImageNet200_online,\
    load_MNIST_online, cifar10_adjust_lr, cifar100_adjust_lr, calc_TopK_Acc, ImgaeNet200_adjust_lr
from label_mapping import labels2Vec, label_greedy_mapping_online
import numpy as np
...
def label_allotter(label_set, train_y, label_dict, dim):
    ...
    for label in new_label:
        label_set.add(label)
        label_vec = label_greedy_mapping_online(label_dict, dim, normal=True, threshold=0.2)
